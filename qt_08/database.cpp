...
void DataBase::AddDataBase(QString driver, QString nameDB)
{
    ...
    //connectionName = nameDB.isEmpty() ? QSqlDatabase::defaultConnection : nameDB;
 ...
 * \return
 */
void DataBase::RequestToDB(QString request, QString typeRequest)
{
    ...
    if (typeRequest == "Все") {
        ...
        model->select();
        emit sig_SendDataFromDB(model, typeRequest);
    } else {
